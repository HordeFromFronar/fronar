...
show_debug_message("reached highlightrange");
show_debug_message(global.selected);
//show_debug_message(string(object_is_ancestor(character, object_index)));
//Only display range for player characters if one is select
